...
public class ControllerImpl implements Controller {
    ...
    public String makingVehicle(String vehicleName) {
        ...
        //Тези които мога започват да работяв върхи дадената кола
        //Ако няма работници,които да могат да работят хврълям ексепшън

        List<Worker> workers = workerRepository.getWorkers().stream()//suitable ones
        ...
        Vehicle vehicle = vehicleRepository.findByName(vehicleName);//given vehicle.
